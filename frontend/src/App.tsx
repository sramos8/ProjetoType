...
export default function App() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FDF6EC', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      {aba === 'produtos' && (
        <main style={{ maxWidth: 1100, margin: '0 auto', padding: '2rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', marginBottom: '1.5rem' }}>
            <input
              style={{
                padding: '0.7rem 1rem', border: '1.5px solid #E0C9A8',
                borderRadius: '0.6rem', fontFamily: "'DM Sans', sans-serif",
                fontSize: '0.95rem', background: '#FFFBF5', color: '#2C1A0E', outline: 'none',
              }}
      ...
      <Modal
        aberto={confirmarDelete !== null}
        titulo="Remover produto"
        onFechar={() => setConfirmarDelete(null)}
      >
        ...
        <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
          ...
          <button
            onClick={() => confirmarDelete && handleDeletar(confirmarDelete)}
