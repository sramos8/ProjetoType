...
export function Home({ onNavegar, role }: Props) {
  const cards = [
    {
      ...
      emoji: '📦',
      titulo: 'Produtos',
      descricao: 'Cadastre, edite e gerencie o estoque dos produtos da padaria',
      cor: '#C8822A',
      bg: '#FFF7ED',
      border: '#FED7AA',
    ...
    },
    {
      ...
      emoji: '🛒',
      titulo: 'PDV — Vendas',
      descricao: 'Frente de caixa para registrar vendas e baixar estoque automaticamente',
      cor: '#0EA5E9',
      bg: '#EFF6FF',
      border: '#BAE6FD',
      tag: 'Ponto de venda',
    },
    {
      ...
      emoji: '📋',
      titulo: 'Histórico',
      descricao: 'Consulte todas as vendas realizadas com detalhes de itens e pagamentos',
      cor: '#7C3AED',
      bg: '#F5F3FF',
      border: '#DDD6FE',
      tag: 'Registro de vendas',
    },
    {
      id: 'relatorio' as Tab,
      emoji: '📊',
      titulo: 'Relatório',
      descricao: 'Faturamento, ticket médio, produtos mais vendidos e gráfico por dia',
      cor: '#059669',
      bg: '#ECFDF5',
      border: '#A7F3D0',
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FDF6EC', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <header style={{ background: '#2C1A0E', borderBottom: '3px solid #C8822A' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
            ...
            <div>
              <div style={{ fontFamily: "'Playfair Display', serif", fontSize: '1.5rem', color: '#F5DEB3', fontWeight: 700, lineHeight: 1 }}>
                Padaria
              </div>
              <div style={{ fontSize: '0.7rem', color: '#A07850', letterSpacing: '0.12em', textTransform: 'uppercase', marginTop: 2 }}>
                Sistema de Gestão
              </div>
            </div>
          </div>
          <div style={{
            fontSize: '0.82rem', color: '#7A5C4E',
      ...
      {/* Hero */}
      <div style={{
        background: 'linear-gradient(135deg, #3D2010 0%, #5C3520 100%)',
        padding: '3rem 2rem',
        textAlign: 'center',
      }}>
        <h1 style={{
          fontFamily: "'Playfair Display', serif",
          fontSize: '2.4rem', color: '#F5DEB3', fontWeight: 900,
        ...
        <p style={{
          ...
          fontSize: '1rem', color: '#A07850', margin: 0,
        }}>
          ...
          {cards.map(card => (
            <button
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLElement).style.boxShadow = `0 16px 40px ${card.cor}28`;
              }}
              onMouseLeave={e => {
            ...
            >
              ...
              <div style={{
                ...
                <span style={{
                  ...
                  color: card.cor,
                  background: `${card.cor}12`,
                  padding: '3px 8px', borderRadius: '999px',
                }}>
                  {card.tag}
                </span>
                <span style={{ color: card.cor, fontSize: '1.1rem', fontWeight: 700 }}>→</span>
              </div>
            </button>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem' }}>
            {[
              ...
              <div
                key={d.passo}
                onClick={() => onNavegar(d.destino)}
                style={{
                  display: 'flex', alignItems: 'flex-start', gap: '0.75rem',
                  padding: '0.9rem', background: '#FDF6EC',
              ...
              >
                ...
                <p style={{
                  ...
                  fontSize: '0.83rem', color: '#5C3D2E', lineHeight: 1.5,
                }}>
                  {d.texto}
                </p>
              </div>
